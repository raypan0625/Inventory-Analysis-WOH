...
season = read_excel("C:/Users/Yulin Pan/Desktop/woh calculation files/Seasonality_in.xlsx")
cdf3<-read_excel("C:/Users/Yulin Pan/Desktop/48&12&4/Sep 2023/US Final Updated Forecast Sep 2023.xlsx", sheet = "Indoor Stockey Forecast", skip = 1)%>%
...
# previous_month = sum(season[19:30,1])
...
woh<-assortment %>%
  select(Picture, StockKey, `HMNum 1`,`HMNum 2`,`HMNum 3`, `SET Best`, `Product Name`,Tiers,`New Category3`,`New Category3-2`,`First Scan date`,Unit,MP,`Factory Name`, `Country of Factory`,`Units 40' HQ`, `First Cost`)
...
#      }
#    } 
#    `Weekly Sales_SEA`[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + 0.3*woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * #forecast_month
#  }
#  else{
...
#      }
#    }
#    `Weekly Sales_SEA`[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * #forecast_month
#  }
#}
...
for (i in 1:nrow(woh)) {
  if (woh$`AMZ DI List`[i] == "AMZ DI List"){
    if (woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]  + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12 ) * 1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]  + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12 ) * 1.00 / woh$previous_month[i] * JULTODEC)/26.29
    }
    else{
      if (woh$`OH Days`[i] < 30){
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 * 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 * 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JULTODEC)/26.29
      }
      else{
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 * 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12) *1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 * 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i] * 12) *1.00 / woh$previous_month[i] * JULTODEC)/26.29
      }
    }
  }
  else{
    if(woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i] + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i] + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JULTODEC)/26.29
    }
    else{
      if(woh$`OH Days`[i] < 30){
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 * 12 + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 * 12 + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JULTODEC)/26.29
      }
      else{
        ...
        #`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6  * 12 + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JANTOJUN)/25.86
        #`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] = ((woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6  * 12 + woh$`Last 12 WKs Sales - AMZ`[i] * 12) * 1.00 / woh$previous_month[i] * JULTODEC)/26.29
      }
    }
  }
}
...
#   if (woh$`AMZ DI List`[i] == "AMZ DI List"){
#     if (woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
#         w[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty + (woh$`Non-AMZ DI_IN`[i] / 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) * 1.00 / woh$previous_month[i] * CNforecast_ny
#     }
#     else{
#       if (woh$`OH Days`[i] < 30){
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty+ (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * CNforecast_ny
#       }
#       else{
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * CNforecast_ny
#       }
#     } 
#   }
#   else{
#     if(woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
#         w[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty+(woh$`Non-AMZ DI_IN`[i] / 12 + woh$`Last 12 WKs Sales - AMZ`[i]) *1.00/ woh$previous_month[i] * CNforecast_ny
#     }
#     else{
#       if(woh$`OH Days`[i] < 30){
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * CNforecast_ny
#       }
#       else{
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * CNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * CNforecast_ny
#       }
#     }
#   }
#   }
...
#       if (woh$`AMZ DI List`[i] == "AMZ DI List"){
#     if (woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
#         w[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+(woh$`Non-AMZ DI_IN`[i] / 12 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i])*1.00/ woh$previous_month[i] * NonCNforecast_ny
#     }
#     else{
#       if (woh$`OH Days`[i] < 30){
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+ (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * NonCNforecast_ny
#       }
#       else{
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + 0.3 * woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * NonCNforecast_ny
#       }
#     } 
#   }
#   else{
#     if(woh$`OH Days`[i]==0 || woh$`OH Days`[i] > 72){
#         w[i] = (woh$`Non-AMZ DI_IN`[i] / 12 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+(woh$`Non-AMZ DI_IN`[i] / 12 + woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * NonCNforecast_ny
#     }
#     else{
#       if(woh$`OH Days`[i] < 30){
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 5 + woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * NonCNforecast_ny
#       }
#       else{
#         w[i] = (woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + woh$`Last 12 WKs Sales - AMZ`[i]) / woh$previous_month[i] * NonCNforecast_ty+(woh$`Non-AMZ DI_IN`[i]/woh$`OH Days`[i] * 6 + woh$`Last 12 WKs Sales - AMZ`[i])*1.00 / woh$previous_month[i] * NonCNforecast_ny
#       }
#     }
#   }
#   }
...
for (i in 1:length(sales)){
  if(sales[i]>0){
    sales[i] = woh$`Sellable qty in USA`[i]+woh$`Current On Water`[i]+woh$`Pcs in shipping plan`[i]-sales[i]
  }
}
for (i in 1:length(sales)){
  if(sales[i]<0){
...
`Total Dec 2022 Pcs Sales`<- rep(0, nrow(woh))
...
for (i in 1:nrow(woh)){
  `Total Dec 2022 Pcs Sales`[i] = woh$`Weekly Sales_OOS_SEA`[i]*4.428571
...
woh = cbind(woh,`Total Dec 2022 Pcs Sales`, `Total Jan-Jun 2023 Pcs Sales`, `Total Jul-Dec 2023 Pcs Sales`)

            
for(i in 1:nrow(woh)){
  if(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i] > woh$`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] * 16){
    `EOM Dec 2022 Open needed`[i] = 0
  }
  else{
    `EOM Dec 2022 Open needed`[i] = woh$`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] * 16-(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i])
  }
}

for(i in 1:nrow(woh)){
  if(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i] - woh$`Total Jan-Jun 2023 Pcs Sales`[i] > woh$`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] * 16){
    `EOM Jun 2023 Open needed`[i] = 0
  }
  else{
    `EOM Jun 2023 Open needed`[i] = woh$`Weekly Sales_OOS_SEA (Jul-Dec 2023)`[i] * 16-(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i] - woh$`Total Jan-Jun 2023 Pcs Sales`[i])
  }
}

for(i in 1:nrow(woh)){
  if(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i] - woh$`Total Jan-Jun 2023 Pcs Sales`[i] - woh$`Total Jul-Dec 2023 Pcs Sales`[i] > woh$`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] * 16 * 1.00){
    `EOM Dec 2023 Open needed`[i] = 0
  }
  else{
    `EOM Dec 2023 Open needed`[i] = woh$`Weekly Sales_OOS_SEA (Jan-Jun 2023)`[i] * 1.00 * 16-(woh$`Sellable qty in USA`[i] + woh$`Current On Water`[i] - woh$`Total Dec 2022 Pcs Sales`[i] - woh$`Total Jan-Jun 2023 Pcs Sales`[i] - woh$`Total Jul-Dec 2023 Pcs Sales`[i])
  }
}

woh = cbind(woh,`EOM Dec 2022 Open needed`, `EOM Jun 2023 Open needed`, `EOM Dec 2023 Open needed`)
...
`EOM Dec 2023 Finished left $`<-rep(0, nrow(woh))
for (i in 1:nrow(woh)){
  if (`Sum of Full Finished QTY`[i]-`EOM Dec 2022 Open needed`[i] >= 0 ){
    `EOM Dec 2022 Finished left`[i] = `Sum of Full Finished QTY`[i]-`EOM Dec 2022 Open needed`[i]
  }
  ...
  if (`Sum of Full Finished QTY`[i]-`EOM Dec 2023 Open needed`[i] >= 0 ){
    ...
    `EOM Dec 2022 Finished left`[i] = 0
...
`EOM Dec 2022 Finished left $` = dollar_format()(c(`EOM Dec 2022 Finished left` * woh$`First Cost`))
...
for (i in 1:nrow(woh)){
  if(woh$`Sum of Semi-finished QTY`[i] == 0){
    if(woh$`Sum of Full Finished QTY`[i] - woh$`EOM Dec 2022 Open needed`[i] < 0){
      `EOM Dec 2022 Finished/Material left`[i] = 0
    }
    else{
      `EOM Dec 2022 Finished/Material left`[i] = woh$`Sum of Full Finished QTY`[i] - woh$`EOM Dec 2022 Open needed`[i]
    }
  }
  else{
    if(woh$`Sum of Full Finished QTY`[i] - woh$`EOM Dec 2022 Open needed`[i] < 0){
      if(woh$`Sum of Full Finished QTY`[i] + woh$`Sum of Semi-finished QTY`[i]-woh$`EOM Dec 2022 Open needed`[i] < 0){
        `EOM Dec 2022 Finished/Material left`[i] = 0
      }
      else{
        `EOM Dec 2022 Finished/Material left`[i] = woh$`Sum of Full Finished QTY`[i] + woh$`Sum of Semi-finished QTY`[i]-woh$`EOM Dec 2022 Open needed`[i]
      }
    }
    else{
      `EOM Dec 2022 Finished/Material left`[i] = woh$`Sum of Full Finished QTY`[i] + woh$`Sum of Semi-finished QTY`[i]-woh$`EOM Dec 2022 Open needed`[i]
...
```{r}
`EOM Dec 2022 Finished/Material left $` = dollar_format()(c(`EOM Dec 2022 Finished/Material left` * woh$`First Cost`))
...
```{r}
#extract as excel
write_xlsx(woh,"C:\\Users\\Yulin Pan\\Desktop\\Indoor WOH new1.xlsx")
```
